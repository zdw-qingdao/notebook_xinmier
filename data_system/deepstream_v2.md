...
workflow3中根据这个设计文档实现了
workflow4中根据这个设计文档实现了
上面的实现是一些参考，在 workflow5 中实现一个新版本的workflow的执行引擎，执行逻辑，数据类型，代码结构可以沿用workflow2，代码要模块化，代码可读性要好，要实现一些额外的功能；
具体要需要满足下面的要求：
...
出一个完善的设计文档，放在 /home/zhongdawei/code/autopipe/doc/design_doc/workflow/v4/dev.md 中；有不确定的问题要问我；如果我的要求存在问题也要问我；让我先来review这个设计文档，文档review和调整结束后，进行整套系统的实现；
...
确保测试正常；将测试用例运行指令，自定义block的教程都加到 /home/zhongdawei/code/autopipe/doc/design_doc/workflow/v4/dev.md 中；
