...
│   │   │   │       │       └── ...
│   │   │   │       └── meta.json
├── datasets/                                 # 训练集（引用 collections 中的数据组合而成）
│   └── person_det_0.yaml
│
├── code/                                     # 代码管理
│   ├── config/                               # 代码+运行配置
...
└── models/                                   # 训练产出的模型
    └── person_det_yolo11n_0/
        ...
        ├── deployment/
        ├── config/                           # 训练时使用的配置快照
        │   ├── dataset.yaml                  # 复制的训练集 yaml
        │   └── model.yaml                    # 复制的模型配置文件
        ├── meta.json
...
## 项目元信息 collections/项目/info.json
